...
sections:
  - block: hero
    ...
    content:
      eyebrow: 치료후기
      title: 환자들의 이야기
      text: 해아림한의원 잠실점에서 치료받으신 분들이 온라인과 원내에서 직접 남겨주신 이야기입니다.
    design:
      css_class: "bg-gradient-to-br from-primary-600 to-secondary-700 text-white"
      spacing:
        padding: ["4rem", 0, "3rem", 0]

  - block: review-highlight
    content:
      eyebrow: 온라인에서 남겨주신 이야기
      title: 네이버 리뷰
      text: 네이버 스마트플레이스에 남겨주신 실제 방문자 리뷰를 확인하실 수 있습니다.
      button:
        text: 네이버 리뷰 전체 보기
